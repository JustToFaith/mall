package cn.personalweb.oauth.config;
import cn.personalweb.oauth.util.UserJwt;
...
//                return new User(username,new BCryptPasswordEncoder().encode(clientSecret), AuthorityUtils.commaSeparatedStringToAuthorityList(""));
        ...
        //查询数据库
        Result<cn.personalweb.user.pojo.User> user = userFeign.findById(username);
        // 指定角色
    ...
    public static void main(String[] args) {
        String encode = new BCryptPasswordEncoder().encode("szitheima");
