...
import cn.personalweb.goods.pojo.Album;
import cn.personalweb.service.AlbumService;
...
public class AlbumController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = true) Album album,
                                     @PathVariable(value = "page") Integer page,
                                     @PathVariable(value = "size") Integer size) {
        PageInfo<Album> pageInfos = albumService.findPage(album, page, size);
        return new Result<>(true, StatusCode.OK, "查询成功", pageInfos);
    }
